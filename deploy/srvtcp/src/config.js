const config =  {
  ...
  pressure_data_min:process.env.pressure_data_min|| '0',
  pressure_data_max:process.env.pressure_data_max|| '100',
  winddirection_data_min:process.env.winddirection_data_min|| '0',
  winddirection_data_max:process.env.winddirection_data_max|| '100',
