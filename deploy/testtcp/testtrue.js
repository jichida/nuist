...
const ip = 'app.nuistiot.com';//'47.97.174.215';//47.97.174.215 //目标ip
const port = 4000;//parseInt(config.targetport);//目标端口
let timerInterval;
let timerTimeout;
...
const client= net.connect({port:port,host:ip},()=>{
  const bufhex2 = '594700010000053e50e2d7150037010203427e000b7d3100006c00000033818600002b313733312e36332b333039322e3638020102030405060700010203000102033e17f8070001';//sd.getdatahex2_raw(255,'427e00037d1d00000100000003f10101090011001300230094002100008100007d0007');
