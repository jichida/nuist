...
class PageForm extends React.Component {
    ...
    onWindowResize=()=> {
  	...
  	render() {
      const { handleSubmit,onClickRegister,pristine,submitting } = this.props;
    	return (
				<Form
						className="loginForm"
            ...
            onClick={handleSubmit(onClickRegister)}>注册</button>
					</div>
        		</div>
      		</div>
					</Form>
    ...
    render(){
        ...
        */
        return (<div>
          ...
          <PageForm onClickRegister={this.onClickRegister}/>
        </div>
