...
class App extends React.Component {
  	...
  	render() {
	    return (
	      	<div className="addinvestigationPage result">
					...
					<ul>
						<li>
							...
							<div className="btnlist">
								<div><span>A</span><span>78523人</span></div>
								<div className="sel"><span>B</span><span>78523人</span></div>
								<div><span>C</span><span>78523人</span></div>
								<div><span>D</span><span>78523人</span></div>
							</div>
						</li>
					</ul>
	        	</div>
