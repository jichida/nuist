...
import DeviceIcon from 'material-ui/svg-icons/device/devices';//设备
import DeviceGroupIcon from 'material-ui/svg-icons/action/list';//设备分组
...
import HistoryDeviceIcon from 'material-ui/svg-icons/action/history';//历史设备数据
